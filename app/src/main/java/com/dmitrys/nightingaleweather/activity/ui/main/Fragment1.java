...
public class Fragment1 extends Fragment {
    ...
    EditText editTextToSearchCity;
    Button btnToSearchCity;

    Handler handler;
    static DBCity dbCity;

    public Fragment1() { // TODO: rename to WeatherFragment?
        handler = new Handler();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        editTextToSearchCity = (EditText) rootView.findViewById(R.id.editTextToSearchCity);
        btnToSearchCity = (Button) rootView.findViewById(R.id.btnToSearchCity);

        btnToSearchCity.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                changeCity(editTextToSearchCity.getText().toString());
            }
        });
